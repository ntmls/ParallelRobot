define(["require", "exports", "../Core/Vector2"], function (require, exports, Vector2_1) {
    ...
    var ArmPositionsPresenter = /** @class */ (function () {
        function ArmPositionsPresenter(displayParams) {
            this.displayParams = displayParams;
        }
        ArmPositionsPresenter.prototype.present = function (output) {
            // draw the left servo
            ...
            var radians = Vector2_1.Angles.D2R(output.leftServoAngle);
            var v1 = new Vector2_1.Vector2(0, output.armLength1 * this.displayParams.scale).rotate(radians);
            ...
            var radians = -Vector2_1.Angles.D2R(output.rightServoAngle);
            var v1 = new Vector2_1.Vector2(0, output.armLength1 * this.displayParams.scale).rotate(radians);
        ...
        return ArmPositionsPresenter;
    }());
    exports.ArmPositionsPresenter = ArmPositionsPresenter;
});
